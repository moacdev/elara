...
return [
    ...
    'customer' => [
        ...
        'login-form' => [
            ...
            'footer'              => '© Copyright :year APP_NAME, Tous droits réservés',
    ...
    'checkout' => [
        ...
        'onepage' => [
            ...
            'money-desc'          => 'Transfert d\'argent (Orange)',
            'paypal-desc'         => 'Paypal',
    ...
    'mail' => [
        'order' => [
            ...
            'cancel' => [
                ...
                'discount'          => 'Remise',
                'grand-total'       => 'Total',
                'final-summary'     => 'Merci de montrer votre intérêt pour notre magasin, nous vous enverrons le numéro de suivi une fois expédié',
                'help'              => 'Si vous avez besoin d\'aide, veuillez nous contacter à l\'adresse :support_email',
                'thanks'            => 'Merci!',
            ],
        ],
        ...
        'invoice' => [
            ...
            'reminder' => [
                ...
                'your-invoice-is-overdue'                          => 'Votre facture :invoice est en retard de :time.',
                'please-make-your-payment-as-soon-as-possible'     => 'Veuillez effectuer votre paiement dès que possible.',
                'if-you-ve-already-paid-just-disregard-this-email' => 'Si vous avez déjà payé, ignorez cet e-mail.',
            ],
        ],
        ...
        'customer' => [
            ...
            'subscription' => [
                ...
                'greeting'    => 'Bienvenue sur APP_NAME - Abonnement par e-mail',
    ...
    'webkul' => [
        'copy-right' => '© Copyright :year APP_NAME, Tous droits réservés',
    ],
